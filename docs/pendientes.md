...
- Resuelto (2026-09-05): la reinsercion post-penitenciaria
	...
	(`supabase/modulos/reinsercion_ruta_evangelistica.sql`) y un boton
	...
	**Accion requerida del usuario**: ya ejecutada (confirmo haber
	corrido `supabase/modulos/reinsercion_ruta_evangelistica.sql`).
...
- Decision de negocio (2026-09-05): cuando alguien se entrega durante
	...
	**'Culto en salon'** al catalogo de metodologia de Evangelismo en
	`supabase/modulos/evangelismo.sql` (el mismo `do $$` que ya crea el modulo y
	su catalogo para todas las congregaciones, de forma idempotente).
	**Accion requerida del usuario**: re-ejecutar `supabase/modulos/evangelismo.sql`
...
- Resuelto (2026-09-04): los 8 pendientes menores de la ronda de QA de
	...
	3. Acento corregido: `ruta_estaciones.nombre` de "Uno Mas" a "Uno Más"
		 en `supabase/modulos/ruta_evangelistica.sql` (insert para congregaciones
	...
	5. Hardening preparado pero **NO aplicado todavia**:
		 `supabase/modulos/ruta_procesos_responsable_obligatorio.sql` (NOT NULL en
		 ...
		 usuario (`supabase/qa_pruebas/seed_datos_prueba.sql`), asi que se deja para
...
- Resuelto (2026-09-04): seis mejoras a la Ruta Evangelistica en una
	...
	`docs/funcionalidades/mejoras-ruta-evangelistica-2-2026-09-04.md`. **Accion
	requerida del usuario**: ya ejecutada (confirmo haber corrido
	`supabase/reportes/resumen_ruta_distrital.sql` y
	`supabase/modulos/lecciones_ruta_evangelistica.sql`).
...
- Resuelto (2026-09-04): "Equipo de trabajo" nunca pedia zona/centro de
	...
	`docs/fixes/zona-centro-en-responsabilidad-operativa-2026-09-04.md`.
...
- Resuelto (2026-09-03): el contenedor de contenido de MainLayout
	...
	`docs/fixes/ancho-contenido-mainlayout-2026-09-03.md`. No requiere accion en
	base de datos.
- Resuelto (2026-09-03): los mensajes de exito ("notice") se quedaban
	...
	reproducible. Ver `docs/fixes/auto-cierre-mensajes-2026-09-03.md`. No
...
- Resuelto (2026-09-03): mapas de zonas de evangelismo y congregaciones
	...
	`docs/funcionalidades/mapas-zonas-y-congregaciones-2026-09-03.md`. **Accion requerida
	del usuario**: ejecutar `supabase/catalogos/geolocalizacion.sql`. Las zonas y
...
- Resuelto (2026-09-03): ciudad automatica en el catalogo de
	...
	`docs/fixes/ciudad-catalogo-congregaciones-2026-09-03.md`. **Accion
	requerida del usuario**: ejecutar
	`supabase/catalogos/agregar_ciudad_catalogo_congregaciones.sql`.
- Resuelto (2026-09-03): el buscador de Congregacion en Editar pastor
	...
	`docs/fixes/correccion-nombre-congregacion-2026-09-03.md`. **Accion
	requerida del usuario**: ejecutar
	`supabase/catalogos/corregir_nombre_congregacion.sql`.
- Resuelto (2026-09-03): en Pastoral Distrital, "Editar" y "Trasladar"
	...
	Ver `docs/fixes/editar-pastor-buscador-y-licencia-2026-09-03.md`. **Accion
	requerida del usuario**: ejecutar `supabase/distrital/corregir_licencia_pastor.sql`.
- Resuelto (2026-09-03): catalogo de referencia de las 5367
	...
	registrar". Ver `docs/funcionalidades/catalogo-congregaciones-ipuc-2026-09-03.md`.
	**Accion requerida del usuario**: ejecutar
	`supabase/catalogos/catalogo_congregaciones_ipuc.sql` y luego
	`supabase/catalogos/seed_catalogo_congregaciones_ipuc.sql` (una sola vez, carga
	las 5367 filas).
- Resuelto (2026-09-02): SEO basico -- el usuario reporto que
	...
	y `public/sitemap.xml`. Ver `docs/fixes/seo-basico-2026-09-02.md`.
...
- Resuelto (2026-09-02): el menu movil del Sidebar empujaba la pantalla
	...
	`docs/fixes/sidebar-movil-overlay-2026-09-02.md`. No se pudo verificar
...
- Resuelto (2026-09-02): se quito "IPUC" de Inicio y Login unicamente
	...
	como estaban. Ver `docs/funcionalidades/neutralizacion-marca-ipuc-2026-09-02.md`. No
...
- Resuelto (2026-09-02): suscripciones -- cobro por congregacion (v1
	...
	bloqueo. Ver `docs/funcionalidades/suscripciones-2026-09-02.md`. **Accion requerida
	del usuario**: ejecutar `supabase/modulos/suscripciones.sql`, y configurar el
...
- Resuelto (2026-09-02): footer institucional nuevo (SIGAP - Sistema
	...
	`docs/fixes/nombre-completo-y-footer-2026-09-02.md`. No requiere accion del
	usuario.
- Resuelto (2026-09-02): las 4 ideas profundas -- salud de datos del
	...
	`docs/arquitectura/4-ideas-profundas-2026-09-02.md`. **Accion requerida del
	usuario**: ejecutar `supabase/reportes/salud_datos.sql` y
	`supabase/distrital/continuidad_pastoral.sql`.
- Resuelto (2026-09-02): FAQ ampliado (4 -> 13 preguntas, agrupadas) y
	...
	`docs/funcionalidades/faq-y-manual-2026-09-02.md`. No requiere accion del usuario.
- Resuelto (2026-09-02): soporte tecnico (reportar bugs al equipo que
	...
	Ver `docs/funcionalidades/soporte-y-solicitudes-internas-2026-09-02.md`. **Accion
	requerida del usuario**: ejecutar `supabase/soporte/reportes_soporte.sql` y
	`supabase/soporte/solicitudes_jerarquicas.sql`, desplegar la funcion
...
- Resuelto (2026-09-02): 3 utilidades generales pedidas por el usuario --
	...
	`docs/funcionalidades/tres-utilidades-generales-2026-09-02.md`. No requiere accion del
...
- Resuelto (2026-09-02): cerrado el vacio de como se otorga acceso
	...
	`docs/funcionalidades/acceso-jerarquico-distrital-nacional-2026-09-02.md`. **Accion
	requerida del usuario**: ejecutar
	`supabase/soporte/otorgar_rol_jerarquico.sql` y desplegar la funcion nueva
...
- Resuelto (2026-09-02): el campo de nombre editable en Mi perfil
	...
	`docs/fixes/nombre-unico-censo-cuenta-2026-09-02.md`. **Accion requerida del
	usuario**: ejecutar `supabase/soporte/actualizar_mi_nombre.sql`.
- Resuelto (2026-09-02): al probar el flujo real de invitacion se
	...
	`docs/funcionalidades/perfil-nombre-notificaciones-2026-09-02.md`. **Accion requerida
	del usuario**: ejecutar `supabase/modulos/notificaciones.sql`,
	`supabase/modulos/fix_enlace_notificaciones_acceso.sql`, y redesplegar
...
- Resuelto (2026-09-02): logo real de SIGAP (recreado como SVG, sin fondo
	...
	(la app no tenia). Ver `docs/funcionalidades/logo-sigap-2026-09-02.md`. No requiere
	accion del usuario.
- Resuelto (2026-09-02): exportacion con membrete real de la IPUC (logo
	...
	Colombia/espanol. Ver `docs/funcionalidades/exportacion-membrete-ipuc-2026-09-02.md`.
...
- Resuelto (2026-09-02): auditadas las vistas por nivel (local ->
	...
	distritos x 10 comites). Ver `docs/funcionalidades/comites-nacional-2026-09-02.md`.
	**Accion requerida del usuario**: ejecutar
	`supabase/reportes/resumen_mision_juvenil_red_familias.sql` y
	`supabase/reportes/resumen_comites_nacional.sql`.
- Resuelto (2026-09-02): traslado real de feligreses entre congregaciones
	...
	especifica. Ver `docs/funcionalidades/traslados-feligres-pastor-2026-09-02.md`. **Accion
	requerida del usuario**: ejecutar `supabase/distrital/traslados_feligresia.sql` y
	`supabase/distrital/finalizar_asignacion_pastoral.sql`.
- Resuelto (2026-09-02): cerradas las 5 brechas encontradas al auditar si
	...
	`docs/funcionalidades/brechas-distrital-nacional-2026-09-02.md`. **Accion requerida del
	usuario**: ejecutar `supabase/distrital/cargos_distritales.sql` (y
...
- Resuelto (2026-09-02): campo de genero + piramide poblacional, linea de
	...
	`docs/funcionalidades/genero-ciclo-vida-proyeccion-impacto-2026-09-02.md`. **Accion
	requerida del usuario**: ejecutar `supabase/catalogos/genero_personas.sql`.
- Resuelto (2026-09-01): nacional/super_admin no tenian ningun dashboard
	...
	`docs/funcionalidades/dashboard-nacional-2026-09-01.md`. **Accion requerida del
	usuario**: ejecutar `supabase/reportes/resumen_nacional.sql` en el SQL Editor.
- Resuelto (2026-09-01): no existia ningun camino para corregir el
	...
	`supabase/distrital/mover_congregacion_distrito.sql` en el SQL Editor.
- Resuelto (2026-09-01): censo de bautizados y sellados con el Espiritu
	...
	`docs/funcionalidades/censo-bautizados-sellados-2026-09-01.md`. De paso se corrigio un
	...
	de la IPUC hecha (ver `docs/arquitectura/investigacion-metodologia-ipuc-2026-09-01.md`).
...
- Resuelto (2026-09-01): nuevo modulo Obra Carcelaria completo (asistencia
	...
	reclusion por distrito). Ver `docs/funcionalidades/obra-carcelaria-2026-09-01.md`.
...
- Resuelto (2026-09-01): hueco de RLS en Escuela Dominical y Damas Dorcas
	...
	`docs/fixes/fix-rls-escuela-dominical-damas-dorcas-2026-09-01.md`. **Accion
	requerida del usuario**: volver a ejecutar
	`supabase/modulos/escuela_dominical_damas_dorcas.sql` completo en el SQL Editor
...
- Resuelto (2026-08-31): `supabase/distrital/gestion_distrital_congregaciones.sql` ya
	...
	tambien funciona. Ver `docs/funcionalidades/alta-congregaciones-distrital-2026-08-31.md`.
...
- Resuelto (2026-08-31): rediseno del nivel distrital completo (Dashboard,
	...
	`docs/funcionalidades/nivel-distrital-consolidado-2026-08-31.md`. Pendiente: cargar el
...
- Resuelto (2026-09-01): Fase 3 del BI de la IPUC — Escuela Dominical
	...
	`docs/funcionalidades/bi-fase3-escuela-dominical-damas-dorcas-2026-09-01.md`.
- Resuelto (2026-09-01): Fase 2 del BI de la IPUC — 5 insights en el
	...
	`docs/funcionalidades/bi-fase2-insights-2026-09-01.md`. Pendiente: Fase 3 (Escuela
...
- Resuelto (2026-09-01): Fase 1 del BI de la IPUC — sellados con el
	...
	`docs/funcionalidades/bi-fase1-datos-base-2026-09-01.md`. Tambien se corrigio un bug
...
- Corregido (2026-08-31): Poblacion (Feligresia) no mostraba ninguna persona
	...
	`docs/auditorias/bug-critico-poblacion-2026-08-31.md`. Falta probar la paginacion con
...
- Resuelto: las seis estaciones ya tienen pantalla operativa real —
	...
	Ver `docs/funcionalidades/ruta-evangelistica-avanzada-2026-08-31.md`.
...
- Resuelto: lecciones individuales con asistencia por estudiante y registro
	...
	`docs/funcionalidades/ruta-evangelistica-avanzada-2026-08-31.md`.
...
- Antes de agregar un modulo, revisar `docs/arquitectura/arquitectura.md`, el codigo existente y las migraciones aplicadas.
