...
confirme que ya no se van a usar — ver `supabase/qa_pruebas/qa_entorno_pruebas_2026-09-04.sql`
(lo que se creó) y `supabase/qa_pruebas/qa_entorno_pruebas_cleanup.sql` (para
