...
`docs/arquitectura/seguridad-produccion.md` documenta MFA y otros controles como
...
- `docs/auditorias/auditoria-sidebar-preferencias-2026-08-31.md`
...
- Revisar si la tarjeta "Seguridad" de Preferencias personales deberia
  ...
  estatico, una vez se resuelvan los pendientes de `docs/arquitectura/seguridad-produccion.md`.
