...
(`supabase/reportes/resumen_ruta_distrital.sql`), consumida en
...
**`supabase/modulos/lecciones_ruta_evangelistica.sql`** (nuevo): `refam_lecciones`
...
`docs/funcionalidades/rediseno-ruta-evangelistica-2026-09-04.md` para el detalle; el
usuario ya ejecutó `supabase/modulos/evangelismo.sql` y se verificó que el
