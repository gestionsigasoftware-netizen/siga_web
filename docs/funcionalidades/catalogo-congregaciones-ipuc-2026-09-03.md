...
- **`supabase/catalogos/catalogo_congregaciones_ipuc.sql`** (nuevo): tabla
...
- **`supabase/catalogos/seed_catalogo_congregaciones_ipuc.sql`** (nuevo): el
...
1. Ejecutar `supabase/catalogos/catalogo_congregaciones_ipuc.sql`.
2. Ejecutar `supabase/catalogos/seed_catalogo_congregaciones_ipuc.sql` (carga las
