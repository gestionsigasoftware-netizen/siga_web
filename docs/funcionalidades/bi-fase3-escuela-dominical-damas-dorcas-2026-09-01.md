...
## Construido (`supabase/modulos/escuela_dominical_damas_dorcas.sql`, nuevo)
...
faltantes — todo documentado en `docs/funcionalidades/bi-fase1-datos-base-2026-09-01.md`,
`docs/funcionalidades/bi-fase2-insights-2026-09-01.md` y este documento.
