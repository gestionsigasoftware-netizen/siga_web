...
## 1. Soporte técnico (`supabase/soporte/reportes_soporte.sql`, `src/pages/Soporte.jsx`)
...
## 2. Solicitudes internas (`supabase/soporte/solicitudes_jerarquicas.sql`, `src/pages/Solicitudes.jsx`)
...
1. Ejecutar `supabase/soporte/reportes_soporte.sql`.
2. Ejecutar `supabase/soporte/solicitudes_jerarquicas.sql`.
