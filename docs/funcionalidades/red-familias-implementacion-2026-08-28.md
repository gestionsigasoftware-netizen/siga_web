...
Los permisos se agregan en `supabase/schema/accesos.sql` y las tablas en
`supabase/modulos/red_familias.sql`.

## Despliegue

Para una base existente, ejecutar en SQL Editor:

1. `supabase/schema/accesos.sql`
2. `supabase/modulos/red_familias.sql`
