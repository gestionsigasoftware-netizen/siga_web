...
### Base de datos (`supabase/distrital/gestion_distrital_congregaciones.sql`, nuevo archivo)
...
1. Ejecutar `supabase/distrital/gestion_distrital_congregaciones.sql` completo en el
