...
- **`supabase/distrital/traslados_feligresia.sql`** (nuevo): tabla
...
- **`supabase/distrital/finalizar_asignacion_pastoral.sql`** (nuevo):
...
1. `supabase/distrital/traslados_feligresia.sql`
2. `supabase/distrital/finalizar_asignacion_pastoral.sql`
