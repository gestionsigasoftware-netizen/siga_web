...
- **`supabase/reportes/resumen_mision_juvenil_red_familias.sql`**:
...
1. `supabase/reportes/resumen_mision_juvenil_red_familias.sql`
2. `supabase/reportes/resumen_comites_nacional.sql`
