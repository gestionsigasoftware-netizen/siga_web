...
- **`supabase/modulos/ujieres_congregacion.sql`** (nuevo, ejecutar después de
...
`supabase/modulos/ujieres_congregacion.sql` y cargue los 42 nombres desde la
sección "Ujieres" en `/modulos` (alta masiva, pegando la lista
completa de una vez).

## Acción requerida del usuario

1. Ejecutar `supabase/modulos/ujieres_congregacion.sql` en Supabase.
