...
`supabase/modulos/escuela_dominical_damas_dorcas.sql` usaba un patrón de lectura
...
`supabase/modulos/escuela_dominical_damas_dorcas.sql` en el SQL Editor** para que
