...
`trasladar_pastor()` (`supabase/distrital/gestion_pastoral_distrital_v2.sql`) —
...
## Corrección aplicada (`supabase/distrital/gestion_pastoral_distrital_v2.sql`)
...
`supabase/distrital/gestion_pastoral_distrital_v2.sql` en el SQL Editor** para que
