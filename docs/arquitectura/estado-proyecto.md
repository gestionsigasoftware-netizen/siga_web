...
- Modulo Obra Carcelaria: ficha de internos, cultos/REFAM carcelaria,
	...
	centros de reclusion. Ver `docs/funcionalidades/obra-carcelaria-2026-09-01.md`.
- Censo de bautizados y sellados con el Espiritu Santo (hitos
	...
	`docs/funcionalidades/censo-bautizados-sellados-2026-09-01.md`.
...
- Preparación académica y ministerial (2026-08-31): cada pastor puede tener
	...
	de predicador. Ver `supabase/distrital/formacion_pastoral.sql`.
...
- Alta de congregaciones nuevas desde el rol distrital (2026-08-31): un
	...
	`docs/funcionalidades/alta-congregaciones-distrital-2026-08-31.md`.
- Rediseno del nivel distrital (2026-08-31): Resumen, Reportes y Gestion
	...
	`docs/funcionalidades/nivel-distrital-consolidado-2026-08-31.md`.
...
- Migracion `supabase/modulos/ruta_evangelistica.sql` aplicada. Las seis estaciones
...
- `supabase/reportes/vistas_dashboard.sql`
- `supabase/schema/migracion_produccion.sql`
- `supabase/schema/accesos.sql`
- `supabase/distrital/pastoral_distrital.sql`
- `supabase/modulos/notificaciones.sql`
- `supabase/schema/configuracion.sql`
- `supabase/modulos/feligresia.sql`
- `supabase/pwa/asistencia_web.sql`
- `supabase/modulos/evangelismo.sql`
- `supabase/modulos/mision_juvenil.sql`
- `supabase/modulos/ruta_evangelistica.sql`
- `supabase/modulos/actividad_personalizada.sql`
- `supabase/pwa/estadisticas_movil.sql`
- `supabase/schema/seguridad_produccion.sql`
