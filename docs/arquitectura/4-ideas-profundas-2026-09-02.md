...
## 1. Salud de datos (`supabase/reportes/salud_datos.sql`, `src/pages/SaludDatos.jsx`, nuevo, ruta `/salud-datos`)
...
## 4. Continuidad pastoral (`supabase/distrital/continuidad_pastoral.sql`, `src/pages/PastoralDistrital.jsx`)
...
Ejecutar `supabase/reportes/salud_datos.sql` y `supabase/distrital/continuidad_pastoral.sql`
