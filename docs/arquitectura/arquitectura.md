...
- **Distrital**: administra su propio distrito (uno de los 36). Da de alta
	...
	esto, ver `docs/funcionalidades/alta-congregaciones-distrital-2026-08-31.md`. Monitorea
...
`supabase/modulos/evangelismo.sql` documenta esto en el comentario de la tabla:
