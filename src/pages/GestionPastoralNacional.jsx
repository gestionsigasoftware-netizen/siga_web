  ...
  return (
    <section className="card p-5">
      ...
      <form onSubmit={otorgar} className="grid sm:grid-cols-2 gap-3">
        ...
        <label className="text-sm sm:col-span-2 flex items-center gap-1">Correo de acceso<InfoTip texto="Si la persona nunca ha usado SIGAP, le llegará un correo para crear su contraseña. Si ya tiene una cuenta, este correo debe ser el mismo con el que ya inicia sesión -- si no coincide, quedará con dos accesos separados." /><input required type="email" className="input-field mt-1.5 w-full" placeholder="persona@correo.com" value={email} onChange={(event) => setEmail(event.target.value)} /></label>
