...
export default function EducacionArtistica() {
  ...
  return (
    <div className="page-shell">
      ...
      {canEdit === false && <p className="text-sm text-secondary bg-surface-1 rounded p-3">Tienes acceso de consulta. Las altas y modificaciones requieren el permiso de edición de Educación Artística.</p>}
      <Toast>{notice}</Toast>
      ...
      <section className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="card chart-card p-5">
          ...
          <div className="h-56 mt-4">
            {integrantesActivos.length ? <Bar data={disciplinasChartData} options={CHART_OPTIONS} /> : <ChartEmpty message="Sin integrantes registrados todavía." />}
          </div>
        </div>
      </section>
