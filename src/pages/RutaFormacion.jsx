              ...
              <>
                ...
                {mode === "esfob" ? (
                  canEdit && <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-border">
                    {seleccionado.listo && <div className="flex items-center gap-1.5"><button type="button" onClick={() => marcarBautizado(seleccionado)} disabled={saving} className="btn-primary justify-center flex-1">Marcar bautizado</button><InfoTip texto="Registra el bautismo con la fecha de hoy y cierra este proceso de ESFOB. Después, incorpórala a Feligresía desde Amigos para poder iniciar su Discipulado." /></div>}
