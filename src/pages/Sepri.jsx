...
export default function Sepri() {
  ...
  return (
    <div className="page-shell">
      ...
      {!canEdit && <p className="text-sm text-secondary bg-surface-1 rounded p-3">Tienes acceso de consulta. Enviar solicitudes y gestionar delegados requiere el permiso de edición de SEPRI.</p>}
