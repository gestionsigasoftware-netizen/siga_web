...
export default function ExportButtons({ onCsv, onExcel, onPdf, disabled, marca = 'IPUC' }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <button type="button" onClick={onPdf} disabled={disabled} className="btn-secondary px-3" title={`Exportar PDF con membrete ${marca}`} aria-label={`Exportar PDF con membrete ${marca}`}>
