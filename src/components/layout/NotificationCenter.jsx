...
export default function NotificationCenter() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      supabase.from('preferencias_usuario').select('recibir_notificaciones, recibir_alertas, formato_fecha').eq('usuario_id', user.id).maybeSingle(),
